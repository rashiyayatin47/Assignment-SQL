...
SELECT *
FROM restaurants WHERE name LIKE '%cafe';
...
SELECT *
FROM products WHERE price BETWEEN 500 AND 1500;
...
SELECT *
FROM Users WHERE city IN ('Ahmedabad', 'Surat', 'Vadodara');
...
SELECT *
FROM songs WHERE artist_name LIKE '%ar%';
